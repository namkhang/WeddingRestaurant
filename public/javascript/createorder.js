...
var redution = document.getElementById("redution");
var priceinput =  document.getElementById("priceinput");
var pricepayinput = document.getElementById("pricepayinput");
var vouchercodesp = document.getElementById("vouchercodesp");
...
price.addEventListener("change" , () =>{
    let priceorder  = parseInt(price.value);
    let capacityprder = parseInt(capacity.value);
    let redutionorder = parseInt(redution.innerText);
    totalprice.innerText = priceorder * capacityprder;
    let handling = (((priceorder * capacityprder) * redutionorder) / 100 );
    payprice.innerText = parseInt(totalprice.innerText) - parseInt(handling);
    priceinput.value = totalprice.innerText ;
    pricepayinput.value =  payprice.innerText   ;
})
